...
def function2():
    if(request.method == 'POST'):
        ...
        a = "lasagna" if request.form.get('a') else "mondays" if request.form.get('b') else "garfield" if request.form.get('c') else "flag" if request.form.get('d') else ''
        secret = "Hey secret agent! Can you help me find the information hidden in this image?" if request.form.get('d') else ''
        ...
        return render_template('mylabs.html', w1=w1, w2=w2, w3=w3, w4=w4, w5=w5, w6=w6, w7=w7, w8=w8, w9=w9, w10=w10, w11=w11, w12=w12, w13=w13, w14=w14, w15=w15,w16=w16, a=a, one=one, two=two, three=three, four=four, five=five, secret=secret)
